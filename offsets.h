...
#define RANKED_PROGRESS 0xd0 // updated, enjoy
#define PLATFORM 0x430 // updated, enjoy
#define WEAPON_NAME 0x40
#define PLATFORM  0x430 // For Platform Icons/ESP
#define PERSISTENT_LEVEL 0x40 // For Exploits, Updated
#define ISDYING 0x718 // For Exploits, Updated / Skeleton,Boxes,Lines
#define PERSISTENT_LEVEL 0x40 // For Exploits, Updated
#define GlobalAnimRateScale 0xa20 //For Exploits, Updated
#define bADSWhileNotOnGround 0x5869 // For Exploits, Updated
#define CustomTimeDilation 0x600 // For Exploits, Updated
